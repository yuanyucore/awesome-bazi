# Awesome Bazi (Four Pillars of Destiny) [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

> A curated list of awesome Bazi (八字) resources, software libraries, calculators, APIs, and educational materials. 
...
*Classic and modern literature on the study of the Four Pillars of Destiny.*

*   *Di Tian Sui (滴天髓 - Dripping Heaven's Marrow)* - One of the foundational classic texts of Bazi analysis.
*   *San Ming Tong Hui (三命通會)* - A comprehensive classical compendium on the study of destiny.
*   *Bazi - The Destiny Code* by Joey Yap - A modern, accessible English textbook for beginners.

---

## Contributing

Contributions are welcome! If you know of an open-source library, a high-quality calculator, or an exceptional educational resource that belongs here, please read the [contributing guidelines](CONTRIBUTING.md) and submit a pull request.

Please ensure the suggested resources are highly relevant and accurate.

---

## License

To the extent possible under law, the authors have waived all copyright and related or neighboring rights to this work under the [CC0 1.0 Universal License](LICENSE).